...
func (c *PermissionController) List(ctx *gin.Context) {
    ...
    if err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "获取权限列表失败")
        return
    }
...
func (c *PermissionController) Create(ctx *gin.Context) {
    ...
    if err := c.service.CreatePermission(&req); err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "创建权限失败")
        return
    }
...
func (c *PermissionController) Update(ctx *gin.Context) {
    ...
    if err := c.service.Update(id, &req); err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "更新权限失败")
        return
    }
...
func (c *PermissionController) Delete(ctx *gin.Context) {
    ...
    if err := c.service.DeletePermission(id); err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "删除权限失败")
        return
    }
...
func (c *PermissionController) GetByID(ctx *gin.Context) {
    ...
    if err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "获取权限失败")
        return
    }

    resp.Success(ctx, permission)
}
...
func (c *PermissionController) GetByRoleID(ctx *gin.Context) {
    ...
    if err != nil {
        resp.Error(ctx, http.StatusBadRequest, "无效的角色ID")
        return
    }
...
func (c *PermissionController) AssignToRole(ctx *gin.Context) {
    ...
    if err := c.service.AssignToRole(roleID, permissionIDs); err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "分配权限失败")
        return
    }

    resp.Success(ctx, "分配权限成功")
}
...
func (c *PermissionController) GetTree(ctx *gin.Context) {
    ...
    if err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "获取权限树失败")
        return
    }

    resp.Success(ctx, tree)
}
...
func (c *PermissionController) GetMenuPermissions(ctx *gin.Context) {
    ...
    if err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "获取菜单权限失败")
        return
    }

    resp.Success(ctx, menus)
}
...
func (c *PermissionController) GetAllPermissions(ctx *gin.Context) {
    ...
    if err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "获取所有权限失败")
        return
    }
    resp.Success(ctx, permissions)
}
...
func (c *PermissionController) GetButtonPermissions(ctx *gin.Context) {
    ...
    if err != nil {
        resp.Error(ctx, http.StatusInternalServerError, "获取按钮权限失败")
        return
    }

    resp.Success(ctx, buttons)
}
