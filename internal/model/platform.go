...
type Platform struct {
    ...
    OrderMode   int               `json:"order_mode" gorm:"type:tinyint;default:1;comment:平台模式：1-推单；2-拉单"`
...
type PlatformAccount struct {
    ...
    OrderMode       int                      `json:"order_mode" gorm:"type:tinyint;default:1;comment:账号模式：1-推单；2-拉单"` // 账号模式：1-推单；2-拉单
...
type PlatformCreateRequest struct {
    ...
    OrderMode   int    `json:"order_mode" binding:"omitempty,oneof=1 2"`
}
...
type PlatformAccountCreateRequest struct {
    ...
    OrderMode       int     `json:"order_mode" binding:"omitempty,oneof=1 2"`       // 账号模式：1-推单；2-拉单
...
type PlatformAccountUpdateRequest struct {
    AccountName     *string  `json:"account_name" binding:"omitempty,max=50"`
    Type            *int     `json:"type" binding:"omitempty,oneof=1 2"`
    AppKey          *string  `json:"app_key" binding:"omitempty,max=64"`
    AppSecret       *string  `json:"app_secret" binding:"omitempty,max=64"`
    AccountPassword *string  `json:"account_password" binding:"omitempty,max=255"`
    ...
    BindUserName    *string  `json:"bind_user_name" binding:"omitempty,max=50"`
    EnablePullOrder *bool    `json:"enable_pull_order"`
    MaxConcurrency  *int     `json:"max_concurrency" binding:"omitempty,min=1"`
    PollIntervalSec *int     `json:"poll_interval_sec" binding:"omitempty,min=1"`
    PullAction      *string  `json:"pull_action" binding:"omitempty,max=64"`
}
...
type PlatformAccountVariant struct {
	...
	Flag              string           `json:"flag" gorm:"size:64"`                                            // 章鱼平台渠道编码（得众不使用）
