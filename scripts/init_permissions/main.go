	...
	permissions := []model.Permission{
		{
			...
			Type:      "MENU",
			ParentID:  &sysMgt.ID,
			Path:      stringPtr("/pms/resource"),
			Icon:      "i-fe:list",
			Component: stringPtr("/src/views/pms/resource/index.vue"),
			Show:      true,
			Enable:    true,
			Order:     1,
		},
		{
			...
			Type:      "MENU",
			ParentID:  &sysMgt.ID,
			Path:      stringPtr("/pms/role"),
			Icon:      "i-fe:user-check",
			Component: stringPtr("/src/views/pms/role/index.vue"),
			Show:      true,
			Enable:    true,
			Order:     2,
		},
		{
			...
			Type:      "MENU",
			ParentID:  int64Ptr(3),
			Path:      stringPtr("/pms/role/user/:roleId"),
			Icon:      "i-fe:user-plus",
			Component: stringPtr("/src/views/pms/role/role-user.vue"),
			Layout:    stringPtr("full"),
			Show:      false,
			Enable:    true,
			Order:     1,
		},
		{
			...
			Type:      "MENU",
			ParentID:  &sysMgt.ID,
			Path:      stringPtr("/pms/user"),
			Icon:      "i-fe:user",
			Component: stringPtr("/src/views/pms/user/index.vue"),
